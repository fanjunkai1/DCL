...
[![Website](doc/badges/badge-website.svg)](https://fanjunkai1.github.io/projectpage/DCL/index.html)
...
## 🎬 Video demo
To demonstrate the stability of the proposed method, we separately compared it with the latest state-of-the-art video dehazing (e.g., MAP-Net, DVD) and monocular depth estimation methods (e.g., Mono-ViFI, Lite-Mono) on GoProHazy. 
